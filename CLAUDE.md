...
Aplicación para gestión de colaciones. Este repo incluye un catálogo de skills de ingeniería de producción (de [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills)) que gobiernan el workflow de los agentes de IA.

> **Scope:** This file configures agents working on the `app_Colaciones` repository. The reusable assets are the skills in `skills/`.
